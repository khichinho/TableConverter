...
def Find_Table_Cells_Using_Contoures(image):
	...
	_,imgbinary = cv2.threshold(image, 180, 255, 0) #Threshold of binarization = 180
...
def cmp_to_key(mycmp):
    ...
    class K(object):
        ...
        def __lt__(self, other):
            return cmp_last_name(self.obj, other.obj) < 0
...
def html_table_generator():
	...
	table = sorted(table, key=cmp_to_key(cmp_last_name))
